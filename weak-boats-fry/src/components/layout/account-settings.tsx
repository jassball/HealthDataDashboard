...
export const AccountSettings = ({ opened, setOpened, userId }: Props) => {
  ...
  const { name } = queryResult?.data?.data || {};
  ...
  return (
    ...
    >
      ...
      >
        <Text strong>Bruker instillinger</Text>
        <Button
          type="text"
          icon={<CloseOutlined />}
          onClick={() => closeModal()}
      ...
      >
        <Card>
          <Form {...formProps} layout="vertical">
            ...
            />
            <Form.Item label="Navn" name="Navn">
              <Input placeholder="Navn" />
            </Form.Item>
            <Form.Item label="Epost" name="Email">
              <Input placeholder="Epost" />
            </Form.Item>
            <Form.Item label="Job tittel" name="jobTitle">
