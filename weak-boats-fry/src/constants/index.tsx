...
export type TotalCountType = "Pustefrekvens" | "Puls" | "Blodtrykk";
...
export const totalCountVariants: {
  ...
  companies: {
    ...
    title: "Gjennomsnittelig pustefrekvens",
    data: [
      {
        index: "1",
        value: 3500,
  ...
  deals: {
    ...
    title: "Gjennomsnittelig blodtrykk",
    data: [
      {
        index: "1",
        value: 1000,
